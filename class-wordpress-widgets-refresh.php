 ...
 * @author  Contributors to https://github.com/WebDevStudios/WordPress-Widgets-Refresh
 */
class WordPress_Widgets_Refresh {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'wordpress-widgets-refresh';
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_theme_page(
			__( 'Widgets', 'wordpress-widgets-refresh' ),
			__( 'Widgets (Refreshed)', 'wordpress-widgets-refresh' ),
			'read',
			$this->plugin_slug,
